  ...
  <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Comprar tickets </h3>
        ...
        <div class="box-body">
			...
			<form id="nuevo_ticket"  method="post" >
			<?php if($listado){?>
			  <div class="form-group col-md-5">
			    <label for="exampleInputPassword1">Seleccione El evento</label>
					<select name="tipo" id="select_event" class="form-control">
...
?>					</select>	
			 ...
			 <button type="button" id="search_ticket" class="btn btn-primary">Buscar</button>
			 <?php } else { echo 'no hay eventos' ;} ?>

			 <div id="evento_detalles" class="form-group col-md-12">
			 </div>
